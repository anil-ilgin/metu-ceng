...
void test_insert_delete() {
    ...
    list.insertNode(list.getHead(), tmpClass("F", 1));
    list.insertNode(list.getHead(), tmpClass("E", 1));
    list.insertNode(list.getHead(), tmpClass("D", 1));
    list.insertNode(list.getHead(), tmpClass("C", 1));
    list.insertNode(list.getHead(), tmpClass("B", 1));
    list.insertNode(list.getHead(), tmpClass("A", 1));
    list.print();
    list.swap(0,1);
    list.print();
