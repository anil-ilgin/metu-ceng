...
int main(int argc, char* argv[]) {
    ...
    vs1.addFriendship("userName056", "userName163");
    vs1.addFriendship("userName056", "userName392");
    ...
    vs1.subscribe("userName284", "title384");
    vs1.subscribe("userName284", "title061");
    vs1.subscribe("userName284", "title135");
    ...
    cout << "Subscriptions of userName265's friends" << endl;
    vs1.printFriendSubscriptions("userName265");
    cout << "Subscriptions of userName056's friends" << endl;
    vs1.printFriendSubscriptions("userName056");
    cout << "Subscriptions of userName265's friends" << endl;
    vs1.printFriendSubscriptions("userName265");
    cout << "Subscriptions of userName163's friends" << endl;
    vs1.printFriendSubscriptions("userName163");
    cout << "Subscriptions of userName392's friends" << endl;
    vs1.printFriendSubscriptions("userName392");
    cout << "Subscriptions of userName341's friends" << endl;
    vs1.printFriendSubscriptions("userName341");
    cout << vs1.isConnected("userName392","userName163") << endl;
