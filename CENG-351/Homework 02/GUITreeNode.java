...
{
    public CengTreeNode node; // To check and paint while searching
    ...
    public GUITreeNode(CengTreeNode node)
    {
        this.node = node;
        ...
        this.setBorder(BorderFactory.createMatteBorder(4, 4, 4, 4, node.getColor()));
    ...
    private JPanel getNewPadding()
    {
        ...
        padding.setMaximumSize(new Dimension(4, 1000));
        padding.setPreferredSize(new Dimension(4, maxYValue));
